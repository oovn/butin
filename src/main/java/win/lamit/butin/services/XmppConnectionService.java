...
import win.lamit.butin.android.JabberIdContact;
import win.lamit.butin.crypto.OmemoSetting;
import win.lamit.butin.crypto.PgpDecryptionService;
import win.lamit.butin.crypto.PgpEngine;
import win.lamit.butin.crypto.axolotl.AxolotlService;
import win.lamit.butin.crypto.axolotl.FingerprintStatus;
import win.lamit.butin.crypto.axolotl.XmppAxolotlMessage;
import win.lamit.butin.entities.Account;
import win.lamit.butin.entities.Blockable;
import win.lamit.butin.entities.Bookmark;
import win.lamit.butin.entities.Contact;
import win.lamit.butin.entities.Conversation;
import win.lamit.butin.entities.Conversational;
import win.lamit.butin.entities.DownloadableFile;
import win.lamit.butin.entities.Message;
import win.lamit.butin.entities.MucOptions;
import win.lamit.butin.entities.MucOptions.OnRenameListener;
import win.lamit.butin.entities.Presence;
import win.lamit.butin.entities.PresenceTemplate;
import win.lamit.butin.entities.Roster;
import win.lamit.butin.entities.ServiceDiscoveryResult;
import win.lamit.butin.entities.Transferable;
import win.lamit.butin.entities.TransferablePlaceholder;
import win.lamit.butin.generator.AbstractGenerator;
import win.lamit.butin.generator.IqGenerator;
import win.lamit.butin.generator.MessageGenerator;
import win.lamit.butin.generator.PresenceGenerator;
import win.lamit.butin.http.HttpConnectionManager;
import win.lamit.butin.http.CustomURLStreamHandlerFactory;
import win.lamit.butin.parser.AbstractParser;
import win.lamit.butin.parser.IqParser;
import win.lamit.butin.parser.MessageParser;
import win.lamit.butin.parser.PresenceParser;
import win.lamit.butin.persistance.DatabaseBackend;
import win.lamit.butin.persistance.FileBackend;
import win.lamit.butin.ui.SettingsActivity;
import win.lamit.butin.ui.UiCallback;
import win.lamit.butin.ui.interfaces.OnAvatarPublication;
import win.lamit.butin.ui.interfaces.OnMediaLoaded;
import win.lamit.butin.ui.interfaces.OnSearchResultsAvailable;
import win.lamit.butin.utils.Compatibility;
import win.lamit.butin.utils.ConversationsFileObserver;
import win.lamit.butin.utils.CryptoHelper;
import win.lamit.butin.utils.ExceptionHelper;
import win.lamit.butin.utils.MimeUtils;
import win.lamit.butin.utils.PhoneHelper;
import win.lamit.butin.utils.QuickLoader;
import win.lamit.butin.utils.ReplacingSerialSingleThreadExecutor;
import win.lamit.butin.utils.ReplacingTaskManager;
import win.lamit.butin.utils.Resolver;
import win.lamit.butin.utils.SerialSingleThreadExecutor;
import win.lamit.butin.utils.StringUtils;
import win.lamit.butin.utils.WakeLockHelper;
import win.lamit.butin.xml.Namespace;
import win.lamit.butin.utils.XmppUri;
import win.lamit.butin.xml.Element;
import win.lamit.butin.xmpp.OnBindListener;
import win.lamit.butin.xmpp.OnContactStatusChanged;
import win.lamit.butin.xmpp.OnIqPacketReceived;
import win.lamit.butin.xmpp.OnKeyStatusUpdated;
import win.lamit.butin.xmpp.OnMessageAcknowledged;
import win.lamit.butin.xmpp.OnMessagePacketReceived;
import win.lamit.butin.xmpp.OnPresencePacketReceived;
import win.lamit.butin.xmpp.OnStatusChanged;
import win.lamit.butin.xmpp.OnUpdateBlocklist;
import win.lamit.butin.xmpp.Patches;
import win.lamit.butin.xmpp.XmppConnection;
import win.lamit.butin.xmpp.chatstate.ChatState;
import win.lamit.butin.xmpp.forms.Data;
import win.lamit.butin.xmpp.jingle.JingleConnectionManager;
import win.lamit.butin.xmpp.jingle.OnJinglePacketReceived;
import win.lamit.butin.xmpp.jingle.stanzas.JinglePacket;
import win.lamit.butin.xmpp.mam.MamReference;
import win.lamit.butin.xmpp.pep.Avatar;
import win.lamit.butin.xmpp.pep.PublishOptions;
