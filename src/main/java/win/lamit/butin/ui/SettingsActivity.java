...
import win.lamit.butin.services.ExportLogsService;
...
public class SettingsActivity extends XmppActivity implements
	...
	public void onStart() {
		...
		boolean removeLocation = new Intent("win.lamit.butin.location.request").resolveActivity(getPackageManager()) == null;
