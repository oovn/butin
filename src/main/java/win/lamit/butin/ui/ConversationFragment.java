...
import win.lamit.butin.databinding.FragmentConversationBinding;
...
import win.lamit.butin.entities.MucOptions.User;
import win.lamit.butin.entities.Presence;
import win.lamit.butin.entities.ReadByMarker;
import win.lamit.butin.entities.Transferable;
import win.lamit.butin.entities.TransferablePlaceholder;
import win.lamit.butin.http.HttpDownloadConnection;
import win.lamit.butin.persistance.FileBackend;
import win.lamit.butin.services.MessageArchiveService;
import win.lamit.butin.services.XmppConnectionService;
import win.lamit.butin.ui.adapter.MediaPreviewAdapter;
import win.lamit.butin.ui.adapter.MessageAdapter;
import win.lamit.butin.ui.util.ActivityResult;
import win.lamit.butin.ui.util.Attachment;
import win.lamit.butin.ui.util.ConversationMenuConfigurator;
import win.lamit.butin.ui.util.DateSeparator;
import win.lamit.butin.ui.util.EditMessageActionModeCallback;
import win.lamit.butin.ui.util.ListViewUtils;
import win.lamit.butin.ui.util.MenuDoubleTabUtil;
import win.lamit.butin.ui.util.MucDetailsContextMenuHelper;
import win.lamit.butin.ui.util.PendingItem;
import win.lamit.butin.ui.util.PresenceSelector;
import win.lamit.butin.ui.util.ScrollState;
import win.lamit.butin.ui.util.SendButtonAction;
import win.lamit.butin.ui.util.SendButtonTool;
import win.lamit.butin.ui.util.ShareUtil;
import win.lamit.butin.ui.widget.EditMessage;
import win.lamit.butin.utils.GeoHelper;
import win.lamit.butin.utils.MessageUtils;
import win.lamit.butin.utils.NickValidityChecker;
import win.lamit.butin.utils.Patterns;
import win.lamit.butin.utils.QuickLoader;
import win.lamit.butin.utils.StylingHelper;
import win.lamit.butin.utils.TimeframeUtils;
import win.lamit.butin.utils.UIHelper;
import win.lamit.butin.xmpp.XmppConnection;
import win.lamit.butin.xmpp.chatstate.ChatState;
import win.lamit.butin.xmpp.jingle.JingleConnection;
import rocks.xmpp.addr.Jid;

import static win.lamit.butin.ui.XmppActivity.EXTRA_ACCOUNT;
import static win.lamit.butin.ui.XmppActivity.REQUEST_INVITE_TO_CONVERSATION;
import static win.lamit.butin.ui.util.SoftKeyboardUtils.hideSoftKeyboard;
